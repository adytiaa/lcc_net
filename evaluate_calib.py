...
from DataSetLidar import DatasetLidarCamera
...
@ex.config
def config():
    dataset = 'hfl/cam_lidar'
#    data_folder = '/home/ubuntu/KITTI-vol/dataset/'
    data_folder = '/home/aditya/HFL_data/newdata/dataset/'
    test_sequence = 0
 ...
 #   output = '/home/ubuntu/KITTI-vol/output/'  # Put output folder
    output = '/home/aditya/lccnet/output_hfl'
    save_image = False  # Origingal False
    outlier_filter = True
...
def my_main(_config, seed):
    ...
    dataset_class = DatasetLidarCamera
    ...
    if _config['save_log']:
        log_file = f'/home/aditya/lccnet/results_for_paper/log_seq{_config["test_sequence"]}.csv'
    ...
    for batch_idx, sample in enumerate(tqdm(TestImgLoader)):
        ...
        if batch_idx == 0 or not _config['use_prev_output']:
            #  Give input position of the current frame with respect to the GT
